...
\(A_* =  \left\{a : \frac{1}{10^3} > a\right\}\),
\(A^* = \left\{a : a \geq \frac{1}{10^3}\right\}\)
\end{example}
...
\begin{proposition} ДОБАВИТЬ АВТОМАТИЧЕСКИЙ НОМЕР ССЫЛКИ
...
Множество иррациональных чисел обозначается как \(\I\),
а рациональные числа будем записывать через греческие буквы \(\alpha = \left(A_*, A^*\right)\).

\begin{definition}
\textit{Действительным числом} называется любое сечение \(\Q\) вида \(1^\circ\) или
\(2^\circ\).
\end{definition}
