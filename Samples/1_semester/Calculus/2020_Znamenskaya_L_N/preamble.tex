...
% micro topic
\newenvironment{mtopic}[1]{\textbf{#1}\par\vspace{4pt}}{\par\vspace{4pt}}
...
\newtheoremstyle{mystyle}
    ...
    {\the\fontdimen2\font} % отступ после шапки в ширину оступа между словами
    {}                     % настройки шапки теоремы
\theoremstyle{mystyle}
...
\newpagestyle{toc}{
    \setheadrule{0.4pt}
    \sethead{Введение в математический анализ}{}{}
    \setfoot{}{\thepage}{}
}

\newpagestyle{main}{
    \setheadrule{0.4pt}
    \sethead{Введение в математический анализ}{}{\hyperlink{toc}{\;Назад к содержанию}}
    \setfoot{}{\thepage}{}
}
