...
\providecommand{\oCo}{\overline{\Co}}
...
\newpagestyle{toc}{
    \setheadrule{0.4pt}
    \sethead{Теория функций комплексного переменного}{}{}
    \setfoot{}{\thepage}{}
}

\newpagestyle{main}{
    \setheadrule{0.4pt}
    \sethead{Теория функций комплексного переменного}{}{\hyperlink{toc}{\;Назад к содержанию}}
    \setfoot{}{\thepage}{}
}
