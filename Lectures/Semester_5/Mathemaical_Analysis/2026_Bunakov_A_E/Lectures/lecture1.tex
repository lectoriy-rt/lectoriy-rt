...
\begin{minipage}[c]{0.45\textwidth}
    $n = 7$, $\arg_0{z} = -\dfrac{\pi}{6}$, $|z| = 2$, а значит значения корня задаются формулой:
      \[
      z_k = \sqrt[7]{2} \, e^{i \left( -\dfrac{\pi}{42} + \dfrac{2\pi k}{7} \right)}, \quad k = 0, \dots, 6.
      \]
